...
Holds the angular velocity published to the tobot. 
...
Holds the mode entred by the user 1,2,3 or 4. ~\newline
...
Holds the linear velocity published to the robot. 
...
Holds the status of the goal (reachable or not), returned by the {\itshape read\+\_\+status} callback funtion. 
...
Holds the x-\/axis coordinate of the goal of the form (x,y). 
...
Holds the y-\/axis coorfinate of the goal of the form (x,y). 
